<%@ Page Title="" Language="C#" MasterPageFile="~/HotelWeb/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="RecruitmentModify.aspx.cs" Inherits="HotelWeb.Admin.Recruitment.RecruitmentModify" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    <div class="txtContentdiv">
      ...
      职位编号：<asp:Literal ID="ltaPostId" runat="server"></asp:Literal>
      </div>
        <div class="txtItemdiv">
            职位名称：
        ...
        <div class="txtItemdiv">
            职位描述：</div>
        <div class="txtItemdiv">
            <textarea id="txtDesc" cols="100" rows="8" style="width: 768px; height: 100px;" class="txtInput"
                runat="server"></textarea></div>
        <div class="txtItemdiv">
            具体要求：</div>
        <div class="txtItemdiv">
            <textarea id="txtRequire" cols="100" rows="8" style="width: 768px; height: 100px;" class="txtInput"
                runat="server"></textarea></div>
        <div class="txtItemdiv">
            联系人：
        ...
        <div class="txtItemdiv">
            <asp:Button ID="btnModify" CssClass="btncss" runat="server" Text="提交修改" onclick="btnModify_Click" 
               />
